...
\begin{frame}{Backbone Architecture: ResNet50}
    ...
    \end{figure}
    \begin{flushright}
      \tiny{\textcolor{gray}{He, K., Zhang, X., Ren, S., \& Sun, J. (2015). Deep Residual Learning for Image Recognition. CoRR, abs/1512.03385.}}
    \end{flushright}
...
\begin{frame}{Backbone Architecture: EfficientNet}
    ...
    \end{figure}
    \begin{flushright}
      \tiny{\textcolor{gray}{Tan, M., \& Le, Q. V. (2019). EfficientNet: Rethinking Model Scaling for Convolutional Neural Networks. CoRR, abs/1905.11946.}}
    \end{flushright}
\end{frame}
